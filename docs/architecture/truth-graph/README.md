...
> **README catalogue is stale beyond doc 19** — docs 20–30 exist on disk but aren't yet listed here. See nmemo-2yv for cleanup tracking. (Docs 32, 34, 35, 36 ARE listed above; the catalogue stub from doc 20 onwards needs a separate sweep.)
