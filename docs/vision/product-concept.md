...
- **Entity extraction**: People, projects, concepts, and organizations are automatically identified and linked
...
- **Relationship discovery**: Graph traversal finds hidden connections across your knowledge
- **Context preservation**: Not just *what* you said, but *when*, *where*, and *who* with

#### Knowledge That Evolves

Facts change over time. The system tracks this:

> *"John works at Acme Corp"* → Later: *"John joined StartupXYZ"*

Both facts are preserved. The system knows *when* things were true, not just *if* they were true. Query your knowledge at any point in time.
...
Three search strategies work together:
- **Vector search**: Find semantically similar content
- **Graph traversal**: Follow entity relationships to discover connected knowledge
- **Keyword matching**: Exact term matching for precision

Results are intelligently fused to give you the best of all approaches.

---

### 🔄 Contradiction Detection

Your knowledge evolves. Sometimes new information contradicts old. The system notices:

> ⚠️ *"You noted 'Project deadline is March 15' but later said 'Pushed to April'. Which is current?"*

- **Automatic detection**: Conflicting facts are flagged
- **Temporal reasoning**: Recent information can supersede old
- **Human review**: Ambiguous contradictions surface for your decision

Your knowledge base stays consistent and trustworthy.
...
>
> **Community Insight**
> - Your "infrastructure" cluster (Docker, Kubernetes, CI/CD) is growing – 12 connected entities
>
> **Pattern Noticed**
...
The briefing is generated by analyzing your entire knowledge graph overnight – looking for patterns, clusters, and forgotten gems.
...
**v1 (Phases 1-3)**: Telegram bot, core skills, knowledge graph, hybrid retrieval.
**v2 (Phases 4-5)**: Autonomous KARMA agents, community detection, proactive insights.
**v3 (Phase 6+)**: Visual dashboard, desktop integration, deeper research capabilities.
